#include <ikt6_ros/ikt6_iiwa_kinematics_plugin/ikt6_iiwa_kinematics_plugin.h>
#include <class_loader/class_loader.hpp>

#include <tf2_eigen/tf2_eigen.h>

// register IKT6IIWAKinematics as a KinematicsBase implementation
CLASS_LOADER_REGISTER_CLASS(ikt6_ros::IKT6IIWAKinematicsPlugin, kinematics::KinematicsBase)

namespace ikt6_ros
{
IKT6IIWAKinematicsPlugin::IKT6IIWAKinematicsPlugin() : active_(false)
{
}

bool IKT6IIWAKinematicsPlugin::initialize(
    ...
    double search_discretization)
{
  ...
  ROS_ERROR_STREAM_NAMED("ikt6", "IKT6IIWA Robot Parameters"
...
bool IKT6IIWAKinematicsPlugin::getPositionIK(
...
bool IKT6IIWAKinematicsPlugin::searchPositionIK(
    const geometry_msgs::Pose& ik_pose,
    const std::vector<double>& ik_seed_state,
    double timeout,
    std::vector<double>& solution,
...
bool IKT6IIWAKinematicsPlugin::getPositionFK(
...
const std::vector<std::string>& IKT6IIWAKinematicsPlugin::getJointNames() const
{
  return solver_info_.joint_names;
}

const std::vector<std::string>& IKT6IIWAKinematicsPlugin::getLinkNames() const
{
