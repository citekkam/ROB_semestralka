#ifndef IKT6IIWA_KINEMATICS_PLUGIN_
#define IKT6IIWA_KINEMATICS_PLUGIN_
 ...
 */
class IKT6IIWAKinematicsPlugin : public kinematics::KinematicsBase
{
public:
  /**
   *  @brief Default constructor
   */
  IKT6IIWAKinematicsPlugin();
